...
export function addNotificationIconToHeader() {
    ...
    notificationIcon.innerHTML = `
        ...
        <span id="notification-badge" class="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-red-500 text-white text-xs rounded-full flex items-center justify-center font-bold hidden"></span>
    `;
